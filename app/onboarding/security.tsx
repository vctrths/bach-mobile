      ...
      <YStack flex={1} paddingHorizontal="$6" justifyContent="space-between">
        <YStack marginTop="$12" gap="$8">
          ...
          <YStack gap="$6">
            <YStack gap="$2">
              <Text
                color={errors.password ? "$error" : "$text_dark"}
                fontSize="$3"
                fontWeight="500"
              >
                Wachtwoord
              ...
              <Input
                ...
                focusStyle={{
                  borderColor: errors.password ? "$error" : "$background",
                }}
              />
              {errors.password && (
              ...
              <YStack marginTop="$1">
                <Text color="$text_dark" fontSize="$3">
                  je wachtwoord moet minimaal:
                </Text>
                <Text color="$text_dark" fontSize="$3" marginLeft="$2">
                  • 8 tekens lang zijn
                </Text>
                <Text color="$text_dark" fontSize="$3" marginLeft="$2">
                  • 1 speciaal teken bevatten
                </Text>
              </YStack>
            </YStack>
            ...
            <YStack gap="$2">
              <Text
                color={errors.confirmPassword ? "$error" : "$text_dark"}
                fontSize="$3"
                fontWeight="500"
              >
                Bevestig wachtwoord
