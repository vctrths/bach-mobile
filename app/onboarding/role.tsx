...
import { H1, styled, Text, YStack } from "tamagui";
      ...
      <YStack flex={1} paddingHorizontal="$6" justifyContent="space-between">
        <YStack marginTop="$12" gap="$10">
          ...
          <YStack gap="$4">
            <RoleCard
              backgroundColor={
                selectedRole === "tuineigenaar" ? "$background" : "$white"
              }
              borderColor={
                selectedRole === "tuineigenaar" ? "$background" : "$borderColor"
              }
              onPress={() => setSelectedRole("tuineigenaar")}
            >
              <Text
                color={
                  selectedRole === "tuineigenaar" ? "$white" : "$text_dark"
                }
                fontSize="$5"
              >
                Tuineigenaar
            ...
            <RoleCard
              backgroundColor={
                selectedRole === "tuinzoeker" ? "$background" : "$white"
              }
              borderColor={
                selectedRole === "tuinzoeker" ? "$background" : "$borderColor"
              }
