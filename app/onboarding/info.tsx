        ...
        <YStack marginTop="$12" gap="$8">
          ...
          <YStack gap="$4">
            <XStack gap="$4">
              <YStack flex={1} gap="$2">
                <Text
                  color={errors.firstName ? "$error" : "$text_dark"}
                  fontSize="$3"
                  fontWeight="500"
                >
                  Voornaam
                ...
                <Input
                  ...
                  focusStyle={{
                    borderColor: errors.firstName ? "$error" : "$background",
                  }}
                />
                {errors.firstName && (
              ...
              <YStack flex={1} gap="$2">
                <Text
                  color={errors.lastName ? "$error" : "$text_dark"}
                  fontSize="$3"
                  fontWeight="500"
                >
                  Achternaam
                ...
                <Input
                  ...
                  focusStyle={{
                    borderColor: errors.lastName ? "$error" : "$background",
                  }}
                />
                {errors.lastName && (
                  <Text color="$error" fontSize="$2">
            ...
            <YStack gap="$2">
              <Text
                color={errors.email ? "$error" : "$text_dark"}
                fontSize="$3"
                fontWeight="500"
              >
                E-mailadres
              ...
              <Input
                ...
                focusStyle={{
                  borderColor: errors.email ? "$error" : "$background",
                }}
              />
              {errors.email && (
                <Text color="$error" fontSize="$2">
            ...
            <YStack gap="$2">
              <Text
                color={errors.description ? "$error" : "$text_dark"}
                fontSize="$3"
                fontWeight="500"
              >
                Beschrijving
              ...
              <TextArea
                ...
                focusStyle={{
                  borderColor: errors.description ? "$error" : "$background",
                }}
              />
              {errors.description && (
                <Text color="$error" fontSize="$2">
