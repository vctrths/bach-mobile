...
INSERT INTO public.gardens (owner_id, name, location, rating, description, image_url, created_at)
VALUES 
  ('987ded8c-4313-4a18-8920-60815678ffaa', 'Stadstuin Leuven', 'Leuven', 4.8, 'Een compacte maar groene oase in het centrum van de stad.', 'https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=800', now()),
  ('987ded8c-4313-4a18-8920-60815678ffaa', 'Groene Heuvel', 'Heverlee', 4.5, 'Grote tuin met veel potentieel voor groenten.', 'https://images.unsplash.com/photo-1598902108854-10e335ad8e2e?w=800', now()),
  ('987ded8c-4313-4a18-8920-60815678ffaa', 'Kruidentuin Kessel-Lo', 'Kessel-Lo', 4.9, 'Gespecialiseerd in zeldzame medicinale kruiden.', 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800', now())
